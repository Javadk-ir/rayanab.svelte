        ...
        <div class="row shift-tole">
            <div class="col-lg-6 offset-lg-3">
                <div class="page-titles whitecolor text-center padding">
                    <h2 class="font-bold"> تماس با ما</h2>
                    <h3 class="font-light py-3">ما اینجا هستیم</h3>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 order-sm-2">
                    <div class="contact-meta px-2 text-center text-md-start">
                        ...
                        <p class="bottom10"><a href="mailto:polpo@traxagency.co.au">info@rayanab.com</a></p>
                        <p class="bottom10">شنبه تا چهارشنبه 9:30 الی 17:30 / پنجشنبه 9:30 الی 14:00</p>
        ...
        <div class="widget py-5">
            <div class="row">
                <div class="col-md-12 text-center wow fadeIn mt-n3" data-wow-delay="300ms">
                    <h2 class="heading bottom30 darkcolor font-light2 pt-1"><span class="font-normal">تماس </span> با ما
                            ...
                            <div class="row px-2">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="name1" type="text" placeholder="نام :" required  name="نام :" >
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <label for="email1" class="d-none"></label>
                                        <input class="form-control" type="email" id="email1" placeholder="ایمیل :" name="ایمیل :" required>
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <label for="email1" class="d-none"></label>
                                        <input class="form-control" type="تلفن :" id="email1" placeholder="تلفن :" name="تلفن :" required>
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12">
                                    <div class="form-group">
                                        <label for="message1" class="d-none"></label>
                                        <textarea class="form-control" id="message1" placeholder="پیام :" name="پیام :" required> </textarea>
                                    </div>
                                </div>
                                <div class="col-md-12 col-sm-12">
                                    <button type="submit" id="submit_btn1" class="button gradient-btnw w-100">ارسال</button>
                                </div>
                            </div>
                        </form>
                        <ul class="social-icons mt-4 mb-4 mb-sm-0 wow fadeInUp text-center" data-wow-delay="300ms">
